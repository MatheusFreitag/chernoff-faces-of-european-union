      ...
      <div className={styles.mainWrapper}>
        ...
        >
          ...
          <p tabIndex={0} className={styles.regularText}>
            Let's start with the end! In this article, we will explore how
            humans are amazing at recognizing faces, specifically facial
            expressions, and how we can use this ability to quickly interpret
            multiple domains of data by turning them into a facial expression.
            Based on country-level data from the 27 EU countries, we will use
            this technique to algorithmically produce a facial expression for
            each nation. Further explanations are provided in the following
            sections. The end result of this experiment can be seen in the map
            below.
            <br />
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            ever dealt with data you probably realized that looking at tables
            full of number is not the most effective way to make sense of it.
            Humans, creative as we are, created a powerful concept to make data
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            life-saving ability during our evolution, so it is understandable
            that we can, so intuitively and quickly, recognize those who are a
            threat, a friend, someone who needs help, all with a glimpse at
            their expressions. These insights were brought by Herman Chernoff, a
            statistician who proposed in 1973 the concept of{' '}
            ...
            which can be interpreted by us as "a technique in which multiple
            data entries are used to build a human face." The intuition is to
            explore our ability to recognize facial expressions and use it as a
            way to quickly interpret multiple domains of data. Here is where I
            fell into the rabbit hole and started to think about how I can apply
            this "Chernoff Faces" technique to something meaningful for me and
            others.
          </p>
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            source and how you count those muscles). It is challenging to add
            20+ attributes to a digital face, so in this context, a limited set
            of attributes was chosen: Eyebrows, nose, mouth, neck, and skin
            color. Eyebrows here can assume 3 different configurations, as well
            as mouth and skin color. Nose and neck can assume only 2 different
            configurations.
          </p>
          <p tabIndex={0} className={styles.regularText}>
            This small set of features and variations already allows for 108
            different facial outputs, and from examples online you can easily
            find projects with other attributes being used, like face shape, eye
            variations, and many others. And all this assumes the face is
            symmetrical. For asymmetrical faces, you could potentially double
            the possible outcomes.
          </p>
          <p tabIndex={0} className={styles.regularText}>
            Personally, <b>I think this is too much</b> because, in the end, you
            still need to keep a mental map of what each attribute symbolizes.
            Too many attributes will naturally lead to confusion and a loss of
            this technique's power: transmitting information easily and
            instantaneously. It's important to notice that some features are
            more representative than others; for example, eyebrows and smiles
            yield more information and are first perceived than slight tweaks in
            the shape of the nose.
          </p>
          <p tabIndex={0} className={styles.regularText}>
            For this experiment, the number of features and variations were
            explicitly limited to refrain from an explosion of possible
            outcomes, avoiding the overload of our mental map.
          </p>
          <h2 tabIndex={0} className={styles.chapterTitle}>
            4. Methodology
          </h2>
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            widely used to measure the perceived corruption by the population.
            The index ranges from 0 to 100, where 0 means more corrupt, and 100
            means not corrupt. For our Chernoff Faces, data was divided into its
            four quartiles.
          </p>
          <p tabIndex={0} className={styles.regularText}>
            ...
            corrupted countries (as perceived by the population). Between the
            1st and 3rd quartile, a <i>Neutral Eyebrow</i> is given. Finally,
            above the 3rd quartile, an <i>Angry Eyebrow</i> is assigned,
            indicating a high corruption index.
          </p>
          <ExamplesFrame
            numberOfExamples={3}
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            . If you imagine a ladder with steps numbered from 0 at the bottom
            to 10 at the top, you can see it as 10 being you in your best life
            possible, and 0 being your worst outcome.
          </p>
          <p tabIndex={0} className={styles.regularText}>
            Based on each country's self-report, a smile was introduced to the
            face. The smile is happy for countries with a high happiness index.
            A neutral smile is given to countries with a medium happiness index,
            and a sad mouth is given to countries with a low happiness index.
          </p>
          ...
          <p tabIndex={0} className={styles.regularText}>
            ...
            generating faces to communicate data is a powerful tool that I plan
            to explore more. During this project, some key constraints evolved:
          </p>
          <ul>
            <li tabIndex={0}>
              It is all about the mental map. Each extra attribute, and each
              variation of this attribute, creates stress on the amount of
              information a user needs to keep in their minds. Be mindful of
              which attributes you want to choose.
            </li>
            <li tabIndex={0}>
          ...
          <p tabIndex={0} className={styles.regularText}>
            The result, with each EU country holding its own Chernoff Face, can
            be seen in the <b>Result</b> section at the top of this page.
          </p>
          <Footer />
        </main>
        <Modal
